  ...
  return (
    ...
    ${drawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        ...
        {/* pass a cartcontents components here */}
        <CartContents />
      </div>

      {/* checkout button fixed at bottom */}
      
      <div className="botton-0 p-4 bg-white sticky">
        <button className="w-full py-3 font-semibold text-white bg-black rounded-lg hover:bg-gray-800">Checkout</button>
