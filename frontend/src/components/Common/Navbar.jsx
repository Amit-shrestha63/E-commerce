      ...
      >
        ...
        <div className="p-4">
          ...
          <nav className="space-y-4">
            ...
            <Link to="/collections/all?gender=Women" className="block text-gray-600 hover:text-black">
              Women
            </Link>
            <Link to="/collections/all?category=Top+Wear" className="block text-gray-600 hover:text-black">
              Top Wear
            </Link>
            <Link to="/collections/all?category=Bottom+Wear" className="block text-gray-600 hover:text-black">
              Bottom Wear
            </Link>
          </nav>
        </div>
